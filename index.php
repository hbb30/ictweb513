...
<html lang="en">
    <head>
        ...
        <title>Luca's Loaves - Home</title>
    </head>
    ...
    <body>
                    ...
                    <div class="carousel-inner">
                        ...
                        foreach ($images as $index => $image) {
                            ...
                            echo '<div class="carousel-item ' . $activeClass . '">
                                    <img src="image/' . $image . '" class="d-block w-100" alt="Slide ' . ($index + 1) . '">
                                </div>';
                        }
                        ?>
                    </div>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h2 class="modal-title" id="exampleModalLabel">Join us!</h2>
                    </div>
                    <div class="modal-body">
                    <p>Enjoy discounts and recieve early notifications of new product, promos, and sales!</p>
                    <form action="" method="POST">    
                        <div class="form-floating mb-2 mt-3">
                        <input type="text" class="form-control form-control-lg shadow-sm" id="uname" name="uname" autocomplete="off" placeholder="Username" required>
                        <label for="uname">Username</label>
                        </div>
                        <div class="form-floating mb-2 mt-3">
                        <input type="password" class="form-control form-control-lg shadow-sm" id="pword" name="pword" placeholder="Password" auto-complete="off" required>
                        <label for="password">Password</label>
                        </div>
                        <p class="register">Don't have an account? <a href="#" data-bs-toggle="modal" data-bs-target="#createAccountModal">Click here</a> to register</p>

                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" id="btn-guest" data-bs-dismiss="modal">No, thank you.</button>
                            ...
                            <script type="text/javascript">
                                document.getElementById("btn-guest").onclick = function () {
                                    location.href = "guest/guest-page.php";
                                };
                            </script>
                        </div>
                    </form>
        ...
        <div class="modal fade" id="createAccountModal" tabindex="-1" role="dialog" aria-labelledby="createAccountModalLabel" aria-hidden="true" data-backdrop="static">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
